...
int main(int argc, char *argv[])
{
    ...
    TFile* inICfile = new TFile("/afs/cern.ch/work/f/fcetorel/private/work2/Eop/Eop_framework/data/ICch_EB_2018Rereco.root", "READ");
    unsigned size = 111; //#FIXME of IOVs
    ...
    else if (method == "templatefit" or method== "median")
    {
    inEopfile = new TFile("/afs/cern.ch/work/f/fcetorel/private/work2/Eop/Eop_framework/test/Rereco2018/IOV1d/harness_template_barrel/IEta_-85_85_IPhi_1_360/out_file_scalemonitoring.root", "READ");
    }
    else 
    {
    cout << "No acceptable method, try ./SaveICmap_EopCorr [method=mean, median, templatefit]" << endl;
    return 0;
    }
   ...
   TFile *outFile = new TFile("/afs/cern.ch/work/f/fcetorel/private/work2/Eop/Eop_framework/data/ICch_EB_2018RerecoCorr_"+method+".root","RECREATE");
